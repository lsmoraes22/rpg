    ...
    switch(level) {
        ...
        case 0:
            ...
            tiles = [
              ...
              new tile({ x:0*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:1*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:2*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:3*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:4*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:5*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:6*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:7*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:8*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:9*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:10*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:11*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:12*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:13*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:14*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:15*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:16*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:17*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:18*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:19*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:20*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:21*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:22*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:23*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:24*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:25*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:26*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:27*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:28*(gridSize/2), y:8*(gridSize/2), imgName: 'tileset-autumn'}),

              new tile({ x:0*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:1*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:2*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:3*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:4*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:5*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:6*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:7*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:8*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:9*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:10*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:11*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:12*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:13*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:14*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:15*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:16*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:17*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:18*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:19*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:20*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:21*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:22*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:23*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:24*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:25*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:26*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:27*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:28*(gridSize/2), y:9*(gridSize/2), imgName: 'tileset-autumn'}),

              new tile({ x:0*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:1*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:2*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:3*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:4*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:5*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:6*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:7*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:8*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:9*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:10*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:11*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:12*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:13*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:14*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:15*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:16*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:17*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:18*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:19*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:20*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:21*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:22*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:23*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:24*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:25*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:26*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:27*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:28*(gridSize/2), y:10*(gridSize/2), imgName: 'tileset-autumn'}),


              new tile({ x:0*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:1*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:2*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:3*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:4*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:5*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:6*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:7*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:8*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:9*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:10*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:11*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:12*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:13*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:14*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:15*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:16*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:17*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:18*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:19*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:20*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:21*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:22*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:23*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:24*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:25*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:26*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:27*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:28*(gridSize/2), y:11*(gridSize/2), imgName: 'tileset-autumn'}),

              new tile({ x:0*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:1*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:2*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:3*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:4*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:5*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:6*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:7*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:8*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:9*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:10*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:11*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:12*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:13*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:14*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:15*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:16*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:17*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:18*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:19*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:20*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:21*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:22*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:23*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:24*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:25*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:26*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:27*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:28*(gridSize/2), y:12*(gridSize/2), imgName: 'tileset-autumn'}),

              new tile({ x:0*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:1*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:2*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:3*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:4*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:5*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:6*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:7*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:8*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:9*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:10*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:11*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:12*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:13*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:14*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:15*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:16*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:17*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:18*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:19*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:20*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:21*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:22*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:23*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:24*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:25*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:26*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:27*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              new tile({ x:28*(gridSize/2), y:13*(gridSize/2), imgName: 'tileset-autumn'}),
              /**/
            ]
            //Principal = new principal({x:300,y:150, tilesetName: 'skeleton_arow'});
