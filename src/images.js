...
class imageCanvas {
    ...
    resources = [
        ...
        {name: "liveBarr1",               src: this.img_src+"liveBarr1.png",	                sx:0,	sy:0,	width:285,	height:15	},
        {name: "liveBarr2",               src: this.img_src+"liveBarr2.png",	                sx:0,	sy:0,	width:307,	height:34	},
